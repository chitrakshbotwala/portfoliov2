...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    description: (
      <>
        <p>
        As a dedicated and proficient backend developer, I leverage the power of Node.js to build robust, scalable, and efficient server-side applications. 
        My expertise in Node.js allows me to deliver high-performance solutions tailored to meet diverse business needs. 
        </p>
        <p>
        As a backend developer specializing in Node.js, I excel in building scalable, high-performance server-side applications. 
        With extensive experience in frameworks like Express.js and Koa.js, I develop robust RESTful and GraphQL APIs. 
       My proficiency includes managing databases (MySQL, PostgreSQL, MongoDB), implementing secure authentication (JWT, OAuth), and developing real-time applications using WebSockets and Socket.io. 
        I prioritize clean code, rigorous testing (Mocha, Jest), and efficient use of version control (Git). Skilled in CI/CD pipelines, Docker, and cloud platforms (AWS, GCP), I focus on performance optimization and agile collaboration, delivering innovative, reliable backend solutions.
        </p>
      </>
    ),
    featured: false,
  ...
  },
  {
    ...
    description: (
      <>
        <p>
           I always follow these practices on every
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          For developers, there&apos;s nothing better than
